...
from rest_framework.renderers import JSONRenderer  # Добавлено
from django_filters.rest_framework import DjangoFilterBackend
from .models import Brand, Product, Category
from .serializers import BrandSerializer, ProductSerializer, CategorySerializer
import logging
...
class BrandViewSet(viewsets.ModelViewSet):
    ...
    renderer_classes = [JSONRenderer]  # Отключаем Browsable API

    def get_permissions(self):
        """Разрешаем GET запросы всем, остальное только авторизованным"""
